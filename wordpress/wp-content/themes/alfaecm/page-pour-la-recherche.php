...
<section class="recherche recherche-publications">
    <header>
        <h3><a href="<?php echo get_post_type_archive_link('publications'); ?>">Liste des publications</a></h3>
    </header>
    ...
    <footer>
        <a href="<?php echo get_post_type_archive_link('publications'); ?>">Voir tous les publications</a>
    </footer>
</section>

<section class="recherche recherche-actualites">
    <?php
    $category_id = get_category_by_slug('recherche-actualites');
        ...
        $args = array(
            ...
            'tax_query' => array(
                array(
                    ...
                    'terms' => 'recherche-actualites' //if field is ID you can reference by cat/term number
                )
            )
        );
